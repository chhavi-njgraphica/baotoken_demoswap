...
import miningStakeAbi from './abi/TFIminingStake.json'
import {
  contractAddresses,
  SUBTRACT_GAS_LIMIT,
  supportedPools,
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.TFIminingStake = new this.web3.eth.Contract(miningStakeAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.TFIminingStake , contractAddresses.bao[networkId])
